...
# A Practical Example for Usage of the **RMDL7** package

A key benefit of the **RMDL7** package is that it enables further statistical 
analysis of RDML data. This section describes **R** packages 
that link with the **RMDL7** package. It will provide examples on how 
